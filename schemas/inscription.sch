   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-lg-lg-sch-27</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-lg-lg-sch-27</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-dharma-lg-lg-sch-27-->
   <!--RULE -->
   ...
   <!--RULE -->
   <xsl:template match="tei:div[@type='edition']" priority="1003" mode="M34">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="tei:div[@type='edition']" priority="1002" mode="M34">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="tei:div[@type='edition']"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="tei:div" priority="1001" mode="M34">
