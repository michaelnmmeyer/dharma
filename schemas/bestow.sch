...
<xsl:if test="ancestor::tei:div[@type='commentary'] or ancestor::tei:div[@type='apparatus'] or ancestor::tei:p[parent::tei:div[@type='bibliography']]">
   ...
   <!--PATTERN schematron-constraint-dharma-l-mixed-verse-29-->
	...
	<!--RULE -->
<xsl:template match="tei:l[parent::tei:lg[@met='mixed']]" priority="1000" mode="M33">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-dharma-origDate-origDate-50-->
	...
	<!--RULE -->
<xsl:template match="tei:origDate[ancestor::tei:teiHeader]" priority="1000" mode="M52">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:if test="not(parent::tei:msPart) and (local-name(*[1])='idno' or local-name(*[1])='altIdentifier' or normalize-space(.)='')">
   ...
   <!--PATTERN schematron-constraint-dharma-persName-reference-53-->
	...
	<!--RULE -->
<xsl:template match="tei:persName/@ref[ancestor::tei:teiHeader]" priority="1000" mode="M55">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="tei:placeName[@type='settlement']" priority="1005" mode="M56">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="tei:placeName[@type='builtPlace']" priority="1004" mode="M56">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="tei:placeName[@type='cultivation']" priority="1003" mode="M56">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="tei:placeName[@type='hydrographic']" priority="1002" mode="M56">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="tei:placeName[@type='naturalPlace']" priority="1001" mode="M56">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="tei:placeName[@type='undetermined']" priority="1000" mode="M56">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
