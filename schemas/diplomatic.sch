...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="ISO Schematron rules"
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-list-gloss-list-must-have-labels-22</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-list-gloss-list-must-have-labels-22</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-head-head-childs-23</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-head-head-childs-23</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-note-note-24</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-note-note-24</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-milestone-att-unit-n-25</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-milestone-att-unit-n-25</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-bibl-siglum-26</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-bibl-siglum-26</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-l-abstractModel-structure-l-27</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-l-abstractModel-structure-l-27</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-lg-atleast1oflggapl-28</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-lg-atleast1oflggapl-28</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-lg-abstractModel-structure-l-29</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-lg-abstractModel-structure-l-29</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-quotation-quotationContents-30</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-quotation-quotationContents-30</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-change-responsability-31</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-change-responsability-31</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-div-abstractModel-structure-l-34</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-div-abstractModel-structure-l-34</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-div-abstractModel-structure-p-35</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-div-abstractModel-structure-p-35</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">isoschematron-constraint-dharma-space-space-37</xsl:attribute>
            <xsl:attribute name="name">isoschematron-constraint-dharma-space-space-37</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-subst-substContents1-38</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-subst-substContents1-38</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-certainty-usage-certainty-39</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-certainty-usage-certainty-39</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-ab-abstractModel-structure-ab-40</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-ab-abstractModel-structure-ab-40</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-ab-abstractModel-structure-l-41</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-ab-abstractModel-structure-l-41</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-seg-att-type-subtype-42</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-seg-att-type-subtype-42</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-dimensions-duplicateDim-43</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-dimensions-duplicateDim-43</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-origDate-origDate-44</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-origDate-origDate-44</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-signatures-signatures_in_msDesc-45</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-signatures-signatures_in_msDesc-45</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-msIdentifier-msId_minimal-46</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-msIdentifier-msId_minimal-46</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-persName-reference-47</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-persName-reference-47</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">isoschematron-constraint-dharma-placeName-placeName-48</xsl:attribute>
            <xsl:attribute name="name">isoschematron-constraint-dharma-placeName-placeName-48</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-objectIdentifier-objectIdentifier_minimal-49</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-objectIdentifier-objectIdentifier_minimal-49</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">isoschematron-constraint-dharma-listApp-div-50</xsl:attribute>
            <xsl:attribute name="name">isoschematron-constraint-dharma-listApp-div-50</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-lem-exclusion-inside-lem-51</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-lem-exclusion-inside-lem-51</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-rdg-exclusion-inside-lem-52</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-rdg-exclusion-inside-lem-52</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-rdgGrp-only1lem-53</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-rdgGrp-only1lem-53</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">schematron-constraint-dharma-variantEncoding-location-variantEncodingLocation-54</xsl:attribute>
            <xsl:attribute name="name">schematron-constraint-dharma-variantEncoding-location-variantEncodingLocation-54</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<xsl:if test="@rend='stanza' and not(ancestor::tei:div[@type='translation'] or ancestor::tei:div[@type='commentary'])">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>@rend='stanza' can only be used in div[@type='translation'] and in
                            div[@type='commentary']</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M14"/>
   </xsl:template>
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="tei:gap[@unit='line' and @quantity] " priority="1000" mode="M19">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
   ...
   <!--PATTERN schematron-constraint-dharma-rs-rs-rules-16-->
	...
	<!--RULE -->
<xsl:template match="tei:rs[@type='month']" priority="1011" mode="M20">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:rs[@type='month']"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="@key='(caitra or vaisakha or jyaistha or asadha or sravana or bhadrapada or asvina or karttika or margasira or pausa or magha or phalguna)'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="@key='(caitra or vaisakha or jyaistha or asadha or sravana or bhadrapada or asvina or karttika or margasira or pausa or magha or phalguna)'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
                            with the @type="fortnight", you should used one of the following values: caitra, vaisakha, jyaistha, asadha, sravana, bhadrapada, asvina, karttika, margasira, pausa, magha, phalguna.
                        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="tei:rs[@type='fortnight']" priority="1010" mode="M20">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:rs[@type='fortnight']"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="@key='(dark or bright)'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@key='(dark or bright)'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
	  ...
	  <!--RULE -->
<xsl:template match="tei:rs[@type='tithi']" priority="1009" mode="M20">
...
<xsl:if test="@key">
	  ...
	  <!--RULE -->
<xsl:template match="tei:rs[@type='naksatra']" priority="1008" mode="M20">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:rs[@type='naksatra']"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="@key='(krttika or rohini or mrgasirsa or ardra or punarvasu or pusya or aslesa or magha or purva-phalguni or uttara-phalguni or hasta or citra or svati or visakha or anuradha or jyestha or mula or purva-asadha or uttara-asadha or sravana or dhanistha or satabhisaj or purva-bhadrapada or uttara-bhadrapada or revati or asvini or bharani)'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="@key='(krttika or rohini or mrgasirsa or ardra or punarvasu or pusya or aslesa or magha or purva-phalguni or uttara-phalguni or hasta or citra or svati or visakha or anuradha or jyestha or mula or purva-asadha or uttara-asadha or sravana or dhanistha or satabhisaj or purva-bhadrapada or uttara-bhadrapada or revati or asvini or bharani)'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
	  ...
	  <!--RULE -->
<xsl:template match="tei:rs[@type='sadvara']" priority="1007" mode="M20">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:rs[@type='sadvara']"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="@key='(tunglai or hariyang or wurukung or paniruan or was or mawulu)'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="@key='(tunglai or hariyang or wurukung or paniruan or was or mawulu)'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
	  ...
	  <!--RULE -->
<xsl:template match="tei:rs[@type='pancavara']" priority="1006" mode="M20">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:rs[@type='pancavara']"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="@key='(pahing or pon or wagai or kaliwuan or umanis)'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="@key='(pahing or pon or wagai or kaliwuan or umanis)'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
	  ...
	  <!--RULE -->
<xsl:template match="tei:rs[@type='season']" priority="1005" mode="M20">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:rs[@type='season']"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="@key='(hemanta or grisma or varsa)'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="@key='(hemanta or grisma or varsa)'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="tei:rs[@type='chinese']" priority="1003" mode="M20">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:rs[@type='chinese']"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="@key='(rat or buffalo-ox or tiger or hare-cat or dragon or snake or horse or goat or monkey or cock or dog or pig)'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="@key='(rat or buffalo-ox or tiger or hare-cat or dragon or snake or horse or goat or monkey or cock or dog or pig)'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
	  ...
	  <!--RULE -->
<xsl:template match="tei:rs[@type='solstice']" priority="1002" mode="M20">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:rs[@type='solstice']"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="@key='(winter or summer)'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@key='(winter or summer)'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
	  ...
	  <!--RULE -->
<xsl:template match="tei:rs[@type='equinox']" priority="1001" mode="M20">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:rs[@type='equinox']"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="@key='(autumn or spring)'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@key='(autumn or spring)'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
	  ...
	  <!--RULE -->
<xsl:template match="tei:rs[@type='eclipse']" priority="1000" mode="M20">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:rs[@type='eclipse']"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="@key='(lunar or solar)'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@key='(lunar or solar)'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
...
<xsl:if test="@atMost and not(@atLeast)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@atMost and not(@atLeast)">
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
...
<xsl:if test="@atLeast and not(@atMost)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@atLeast and not(@atMost)">
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
            <svrl:text>@atMost
...
<xsl:if test="not(descendant::tei:ex)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(descendant::tei:ex)">
            ...
            <svrl:text>expan should contain
                            ex</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M23"/>
...
<xsl:if test="@target and @cRef">
   ...
   <!--PATTERN schematron-constraint-dharma-list-gloss-list-must-have-labels-22-->
...
<xsl:choose>
   ...
   <!--PATTERN schematron-constraint-dharma-head-head-childs-23-->


	<!--RULE -->
<xsl:template match="tei:head/child::tei:*" priority="1000" mode="M27">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="local-name()= ('foreign')">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--PATTERN schematron-constraint-dharma-note-note-24-->


	<!--RULE -->
<xsl:template match="tei:note" priority="1000" mode="M28">
...
<xsl:if test="child::tei:note">
   ...
   <!--PATTERN schematron-constraint-dharma-milestone-att-unit-n-25-->


	<!--RULE -->
<xsl:template match="tei:milestone" priority="1004" mode="M29">
...
<xsl:if test="not(@unit and @n)">
	  ...
	  <!--RULE -->
<xsl:template match="tei:milestone[@type='yati']" priority="1003" mode="M29">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:milestone[@type='yati']"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="@type='yati' and @break='no'"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@type='yati' and @break='no'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
	  ...
	  <!--RULE -->
<xsl:template match="tei:milestone[@type='ref']" priority="1002" mode="M29">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:milestone[@type='ref']"/>
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="tei:milestone[@type='ref']" priority="1001" mode="M29">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:milestone[@type='ref']"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@unit='stanza' or @unit='line'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
	  ...
	  <!--RULE -->
<xsl:template match="tei:milestone[@type='ref']" priority="1000" mode="M29">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:milestone[@type='ref']"/>
...
<xsl:if test="not(@n)">
   ...
   <!--PATTERN schematron-constraint-dharma-bibl-siglum-26-->


	<!--RULE -->
<xsl:template match="tei:bibl[ancestor::tei:listBibl]" priority="1001" mode="M30">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:if test="child::tei:note[following-sibling::tei:*]">
	  ...
	  <!--RULE -->
<xsl:template match="tei:bibl[child::tei:note]" priority="1000" mode="M30">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:bibl[child::tei:note]"/>
...
<xsl:if test="ancestor::tei:div[@type='commentary'] or ancestor::tei:div[@type='apparatus'] or ancestor::tei:p[parent::tei:div[@type='bibliography']]">
   ...
   <!--PATTERN schematron-constraint-dharma-l-abstractModel-structure-l-27-->
...
<xsl:if test="ancestor::tei:l[not(.//tei:note//tei:l[. = current()])]">
   ...
   <!--PATTERN schematron-constraint-dharma-lg-atleast1oflggapl-28-->
...
<xsl:choose>
   ...
   <!--PATTERN schematron-constraint-dharma-lg-abstractModel-structure-l-29-->
...
<xsl:if test="ancestor::tei:l[not(.//tei:note//tei:lg[. = current()])]">
   ...
   <!--PATTERN schematron-constraint-dharma-quotation-quotationContents-30-->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-dharma-change-responsability-31-->


	<!--RULE -->
<xsl:template match="@who" priority="1000" mode="M35">
...
<xsl:choose>
   ...
   <!--PATTERN schematron-constraint-dharma-div-abstractModel-structure-l-34-->
...
<xsl:if test="ancestor::tei:l">
   ...
   <!--PATTERN schematron-constraint-dharma-div-abstractModel-structure-p-35-->
...
<xsl:if test="ancestor::tei:p or ancestor::tei:ab and not(ancestor::tei:floatingText)">
   ...
   <!--PATTERN isoschematron-constraint-dharma-space-space-37-->


	<!--RULE -->
<xsl:template match="tei:space" priority="1002" mode="M39">
...
<xsl:if test="@quantity and not(@unit)">
	  ...
	  <!--RULE -->
<xsl:template match="tei:space" priority="1001" mode="M39">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:space"/>
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="tei:space" priority="1000" mode="M39">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:space"/>
...
<xsl:if test="@unit='page'">
   ...
   <!--PATTERN schematron-constraint-dharma-subst-substContents1-38-->


	<!--RULE -->
<xsl:template match="tei:subst" priority="1000" mode="M40">
...
<xsl:choose>
   ...
   <!--PATTERN schematron-constraint-dharma-certainty-usage-certainty-39-->


	<!--RULE -->
<xsl:template match="tei:certainty" priority="1003" mode="M41">
...
<xsl:if test="@match='../@met' and not(parent::tei:lg)">
	  ...
	  <!--RULE -->
<xsl:template match="tei:certainty" priority="1002" mode="M41">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:certainty"/>
...
<xsl:if test="@match='..' and not(parent::tei:gap)">
	  ...
	  <!--RULE -->
<xsl:template match="tei:certainty" priority="1001" mode="M41">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:certainty"/>
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="tei:certainty" priority="1000" mode="M41">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:certainty"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="@match='..' and @locus='name'">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--PATTERN schematron-constraint-dharma-ab-abstractModel-structure-ab-40-->
...
<xsl:if test="not(ancestor::tei:floatingText) and (ancestor::tei:p or ancestor::tei:ab)          and not(parent::tei:exemplum         |parent::tei:item         |parent::tei:note         |parent::tei:q         |parent::tei:quote         |parent::tei:remarks         |parent::tei:said         |parent::tei:sp         |parent::tei:stage         |parent::tei:cell         |parent::tei:figure)">
   ...
   <!--PATTERN schematron-constraint-dharma-ab-abstractModel-structure-l-41-->


	<!--RULE -->
<xsl:template match="tei:ab" priority="1000" mode="M43">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="tei:ab"/>
...
<xsl:if test="ancestor::tei:l or ancestor::tei:lg">
   ...
   <!--PATTERN schematron-constraint-dharma-seg-att-type-subtype-42-->


	<!--RULE -->
<xsl:template match="tei:seg" priority="1000" mode="M44">
...
<xsl:if test="@rend='pun' and not(ancestor::tei:div[@type='translation'])">
   ...
   <!--PATTERN schematron-constraint-dharma-dimensions-duplicateDim-43-->


	<!--RULE -->
<xsl:template match="tei:dimensions" priority="1000" mode="M45">
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-dharma-origDate-origDate-44-->


	<!--RULE -->
<xsl:template match="tei:origDate[ancestor::tei:teiHeader]" priority="1000" mode="M46">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
   ...
   <!--PATTERN schematron-constraint-dharma-signatures-signatures_in_msDesc-45-->


	<!--RULE -->
<xsl:template match="tei:signatures" priority="1000" mode="M47">
...
<xsl:choose>
   ...
   <!--PATTERN schematron-constraint-dharma-msIdentifier-msId_minimal-46-->


	<!--RULE -->
<xsl:template match="tei:msIdentifier" priority="1000" mode="M48">
...
<xsl:if test="not(parent::tei:msPart) and (local-name(*[1])='idno' or local-name(*[1])='altIdentifier' or normalize-space(.)='')">
   ...
   <!--PATTERN schematron-constraint-dharma-persName-reference-47-->


	<!--RULE -->
<xsl:template match="tei:persName/@ref[ancestor::tei:teiHeader]" priority="1000" mode="M49">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
   ...
   <!--PATTERN isoschematron-constraint-dharma-placeName-placeName-48-->


	<!--RULE -->
<xsl:template match="tei:placeName[@type='region']" priority="1004" mode="M50">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="tei:placeName[@type='settlement']" priority="1003" mode="M50">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="tei:placeName[@type='builtPlace']" priority="1002" mode="M50">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="tei:placeName[@type='cultivation']" priority="1001" mode="M50">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="tei:placeName[@type='naturalPlace']" priority="1000" mode="M50">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
   ...
   <!--PATTERN schematron-constraint-dharma-objectIdentifier-objectIdentifier_minimal-49-->


	<!--RULE -->
<xsl:template match="tei:objectIdentifier" priority="1000" mode="M51">
...
<xsl:if test="not(count(*) gt 0)">
   ...
   <!--PATTERN isoschematron-constraint-dharma-listApp-div-50-->


	<!--RULE -->
<xsl:template match="tei:listApp" priority="1000" mode="M52">
...
<xsl:choose>
   ...
   <!--PATTERN schematron-constraint-dharma-lem-exclusion-inside-lem-51-->


	<!--RULE -->
<xsl:template match="tei:lem" priority="1000" mode="M53">
...
<xsl:if test="child::tei:l">
   ...
   <!--PATTERN schematron-constraint-dharma-rdg-exclusion-inside-lem-52-->


	<!--RULE -->
<xsl:template match="tei:rdg" priority="1000" mode="M54">
...
<xsl:if test="child::tei:l">
   ...
   <!--PATTERN schematron-constraint-dharma-rdgGrp-only1lem-53-->


	<!--RULE -->
<xsl:template match="tei:rdgGrp" priority="1000" mode="M55">
...
<xsl:choose>
   ...
   <!--PATTERN schematron-constraint-dharma-variantEncoding-location-variantEncodingLocation-54-->


	<!--RULE -->
<xsl:template match="tei:variantEncoding" priority="1000" mode="M56">
